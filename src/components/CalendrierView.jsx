...
import { CALENDRIER_DEFAULT, MOIS, LEGENDE } from "../constants/calendrier";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
        <div className="lora" style={{ fontSize: 16, fontWeight: 700, color: C.text }}>
          📅 Calendrier cultural
        </div>
      ...
      {calendrier.map((row, rowIdx) => (
        <div key={rowIdx}>
          <div style={{
            ...
            <button
              onClick={() => setEditRow(editRow === rowIdx ? null : rowIdx)}
              style={{
            ...
            <div style={{
              ...
              {row.periodes.map((p, pi) => (
                <div key={pi} style={{
                  ...
                  borderBottom: `1px dashed ${C.borderDash}`,
                }}>
